...
if data_table is None:
    ...
    for texture_path in texture_assets:
        ...
        new_row = unreal.StructLibrary.make_structure(s_flag_struct)
        new_row.CountryCode = country_code
        new_row.FlagTexture = texture
        
        # Ajouter la nouvelle ligne à la DataTable
        unreal.DataTableFunctionLibrary.add_row(data_table, country_code, new_row)
